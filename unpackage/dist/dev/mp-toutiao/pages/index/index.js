...
/* 12 */
/*!*************************************************************************************************!*\
  !*** /Users/yanghao/Documents/HBuilderProjects/client/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*************************************************************************************************/
...
/* 13 */
/*!******************************************************************************!*\
  !*** /Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue ***!
  \******************************************************************************/
/*! no static exports found */
...
/* 14 */
/*!*************************************************************************************************************!*\
  !*** /Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*************************************************************************************************************/
...
/* 15 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var l0 = _vm.__map(_vm.column, function(data, index) {
    var $orig = _vm.__get_orig(data)

    var m0 = _vm.toFixed(data.price)
    var m1 = _vm.toFixed(data.showPrice)
    return {
      $orig: $orig,
      m0: m0,
      m1: m1
...
/* 16 */
/*!*******************************************************************************************************!*\
  !*** /Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 17 */
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _menu = _interopRequireDefault(__webpack_require__(/*! @/pages/index/menu.json */ 18));
var _coulumn = _interopRequireDefault(__webpack_require__(/*! @/pages/index/coulumn.json */ 19));

var _login = __webpack_require__(/*! @/request/login */ 20);

var _utils = __webpack_require__(/*! @/utils/utils */ 21);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
var _default = { data: function data() {return { // 菜单列表
      menulist: [], // 课程列表
      column: [], title: 'Hello', keyword: "", input: '' };}, onLoad: function onLoad() {// this.menulist = menujson
    // this.column = coulumn
    // this.column.push()
    // 判断token是否存在
    if (!uni.getStorageSync('login_session')) {// 登陆
      (0, _login.wx_login)(); // this.$forceUpdate()
    } // 获取课程列表
    this.GetCourseList();}, methods: { toFixed: _utils.toFixed, // 获取首页课程列表
    GetCourseList: function GetCourseList() {var that = this; // 获取登陆存储的token
      console.log(uni.getStorageSync('login_session'));console.log(uni.getStorageSync('login_oauth'));uni.request({ url: uni.COURSE_LIST, method: 'GET', header: { 'token': uni.getStorageSync('login_session'), //获取登陆信息
          'channel': uni.getStorageSync('login_oauth') }, success: function success(res) {console.log(res);uni.showToast({ title: res.data.msg, duration: 2000 });if (res) {that.column = res.data.data.data;}}, fail: function fail(res) {console.log(res);} });}, // banner跳转申请页面
    teacherapply: function teacherapply() {uni.navigateTo({ url: '/pages/apply/apply' });}, // 输入框
    inputPlaceholder: function inputPlaceholder(e) {if (uni.getStorageSync('CURRENT_LANG') == "en") {return 'Please enter the search content';} else {return '请输入搜索内容';}}, // 首页课程点击跳转
    columnOnclick: function columnOnclick(id) {// console.log(e)
      uni.navigateTo({ url: "/pages/detail/detail?courseid=".concat(id) });}, // 前往菜单页
    gotomenu: function gotomenu() {uni.navigateTo({ url: '/pages/detail/cate/cate', // url: '/pages/common/webview/webview?url=' + item.open_url + '&title=' + item.title,
        success: function success(res) {}, fail: function fail() {}, complete: function complete() {} });}, // 前往已购界面
    gotobuycourse: function gotobuycourse() {uni.switchTab({ url: '/pages/study/study' });}, // 前往申请入驻界面
    gototeacherapply: function gototeacherapply() {uni.navigateTo({ url: '/pages/apply/apply', success: function success(res) {}, fail: function fail() {}, complete: function complete() {} });}, // 搜索跳转
    searchClick: function searchClick() {uni.navigateTo({ url: '/pages/search/search', success: function success(res) {}, fail: function fail() {}, complete: function complete() {} });} } };exports.default = _default;
...
/* 22 */
/*!****************************************************************************************************************!*\
  !*** /Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 23 */
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/yanghao/Documents/HBuilderProjects/client/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
