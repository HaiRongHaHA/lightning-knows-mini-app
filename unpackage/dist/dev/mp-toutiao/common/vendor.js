...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"client","VUE_APP_PLATFORM":"mp-toutiao","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.toFixed = toFixed; /**
                                                                                                       * @description: 四舍五入保留d位小数
                                                                                                       * @param {Number} num 需要计算的数
                                                                                                       * @param {Number} d 默认保留2位
                                                                                                       * @return {Number} 四舍五入保留d位小数结果
                                                                                                       */
function toFixed(num) {var d = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  var digit = Math.pow(10, d);
  var res = num * digit + 0.5;
